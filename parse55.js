...
var Dictionary = {
    ...
    fpsc: '&fpsc^A(fpsc):B[front0.2]~A-B::!-1-A;B-1-A',
    bpsc: '&bpsc^A(bpsc):B[back0.2]~A-B::!-1-A;B-1-A',
    rsc: '&rsc^A(rsc):B~A-B::!-1-A;B-1-A',
    hdc: '&hdc^A(hdc):B~A-B::!-1-A;B-1.5-A',
    bphdc: '&bphdc^A(bphdc):B[back0.3]~A-B::!-1-A;B-1.3-A',
    fphdc: '&fphdc^A(fphdc):B[front0.3]~A-B::!-1-A;B-1.3-A',
    dc: '&dc^A(dc):B~A-B::!-1-A;B-2-A',
    bpdc: '&bpdc^A(bpdc):B[back0.4]~A-B::!-1-A;B-1.5-A',
    fpdc: '&fpdc^A(fpdc):B[front0.4]~A-B::!-1-A;B-1.5-A',
    bptr: '&bptr^A(bptr):B[back0.6]~A-B::!-1-A;B-2.5-A',
    fptr: '&fptr^A(fptr):B[front0.6]~A-B::!-1-A;B-2.5-A',
