...
/* periphery_worker.js
 *
 * Runs periphery computation in a Web Worker using Emscripten output periphery3.js/periphery3.wasm.
...
function init() {
  ...
  // IMPORTANT: the compiled output must be named `periphery3.js` and sit next to this worker.
  importScripts('periphery3.js');
}

init();

function ensureReady() {
  if (!ready) throw new Error('periphery3.js not ready yet');
}
